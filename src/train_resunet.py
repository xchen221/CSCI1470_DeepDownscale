...
def main():
    ...
    save_path = "outputs/checkpoints/best_resunet_t_elev.pt"
    history_path = "outputs/resunet_t_elev_loss_history.csv"

    device = get_device()
    print("Using device:", device)

    train_ds = DownscaleDatasetResUnet(train_path, topo_path)
    val_ds = DownscaleDatasetResUnet(val_path, topo_path)
