...
def main():
    ...
    checkpoint_path = "outputs/checkpoints/best_unet_t_elev_urban.pt"
    output_path = "outputs/test_predictions_unet_t_elev_urban.nc"
    ...
    ds_out = xr.Dataset(
        ...
        attrs={
            "description": "U-Net (temperature + elevation + urban) predictions on test set"
        }
    )
