...
def main():
    ...
    checkpoint_path = "outputs/checkpoints/best_transformer_x_d2m_elev.pt"
    output_path = "outputs/test_predictions_transformer_t_elev_d2m.nc"
    ...
    # dataset / loader
    test_ds = DownscaleDatasetXD2MElev(
    ...
    ds_out = xr.Dataset(
        ...
        attrs={
            "description": "Transformer U-Net bottleneck predictions on test set using x_norm + d2m_norm + elevation"
        },
    )
