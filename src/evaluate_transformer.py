...
def main():
    ...
    checkpoint_path = "outputs/checkpoints/best_transformer_t_elev.pt"
    output_path = "outputs/test_predictions_transformer_t_elev.nc"
    ...
    # model
    model = UNetTransformerDownscale(
        in_channels=2,
        out_channels=1,
        base_channels=32,
        embed_dim=64,
