...
def main():
    ...
    checkpoint_path = "outputs/checkpoints/best_unet_x_d2m_elev.pt"
    output_path = "outputs/test_predictions_x_d2m_elev.nc"
    ...
    ds_out = xr.Dataset(
        ...
        attrs={
            "description": "U-Net predictions on test set using x_norm + d2m_norm + elevation"
        }
    )
